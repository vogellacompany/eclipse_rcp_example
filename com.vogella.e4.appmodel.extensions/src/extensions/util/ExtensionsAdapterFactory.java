...
public class ExtensionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExtensionsSwitch<Adapter> modelSwitch =
		new ExtensionsSwitch<Adapter>() {
			@Override
			public Adapter caseBrowserPart(BrowserPart object) {
				return createBrowserPartAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link extensions.BrowserPart <em>Browser Part</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBrowserPartAdapter() {
		return null;
	}
