...
@Component(service = ExtendedObjectSupplier.class, property = "dependency.injection.annotation=com.example.e4.rcp.todo.ownannotation.DirectTodo")
public class DirectTodoObjectSupplier extends ExtendedObjectSupplier {
	...
	public Object get(IObjectDescriptor descriptor, IRequestor requestor, boolean track, boolean group) {
		...
		// get the Todo, which has the given id or null, if there is no Todo
		// with the given id
